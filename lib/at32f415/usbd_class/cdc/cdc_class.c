...
// customized callback handler functions
__WEAK void usb_vcp_ept0_tx_complete_cb(void *udev) {}
__WEAK void usb_vcp_ept0_rx_complete_cb(void *udev) {}
__WEAK void usb_vcp_in_complete_cb(void *udev, uint8_t ept_num) {}
__WEAK void usb_vcp_out_complete_cb(void *udev, uint8_t ept_num) {}
__WEAK void usb_vcp_sof_cb(void *udev) {}
__WEAK void usb_vcp_device_reset_cb(void *udev) {}
__WEAK void usb_vcp_device_suspend_cb(void *udev) {}
__WEAK void usb_vcp_device_wakeup_cb(void *udev) {}
...
static usb_sts_type class_ept0_tx_handler(void *udev)
{
  ...
  /* ...user code... */
  usb_vcp_ept0_tx_complete_cb(udev);
...
static usb_sts_type class_ept0_rx_handler(void *udev)
{
  ...
  /* ...user code... */
  usb_vcp_ept0_rx_complete_cb(udev);
...
static usb_sts_type class_in_handler(void *udev, uint8_t ept_num)
{
  ...
  */
  ...
  usb_vcp_in_complete_cb(udev, ept_num);
  return status;
}
...
static usb_sts_type class_out_handler(void *udev, uint8_t ept_num)
{
  ...
  /* ...user code... */
  usb_vcp_out_complete_cb(udev, ept_num);
...
static usb_sts_type class_event_handler(void *udev, usbd_event_type event)
{
  ...
  switch(event)
  {
    case USBD_RESET_EVENT:
      ...
      /* ...user code... */
      usb_vcp_device_reset_cb(udev);

      break;
    case USBD_SUSPEND_EVENT:

      /* ...user code... */
      usb_vcp_device_suspend_cb(udev);

      break;
    case USBD_WAKEUP_EVENT:
      /* ...user code... */
      usb_vcp_device_wakeup_cb(udev);
